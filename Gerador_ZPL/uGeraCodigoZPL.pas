...
//atributos e metodos publicos
  ...
  function GerarCodigoZPL( aPontoInicialImpressao_MargemEsquerda :string; aPontoInicialImpressao_Topo :string;
    ...
    aProdutoValor, aProdutoDataValidade :string; aProdutoDataEntrega :string) :string;
end;
...
function TGeraCodigoZPL.GerarCodigoZPL(aPontoInicialImpressao_MargemEsquerda,
          ...
          aProdutoDescricao, aProdutoQuantidade, aProdutoValor, aProdutoDataValidade,
          aProdutoDataEntrega: string) :string;
var
...
begin
  ...
  try
    ...
    vCodigoZPL := vCodigoZPL + '^CF0,40' + #13#10;
    ...
    vCodigoZPL := vCodigoZPL + '^FO50,150' + '^FD' + 'Produto: ' + vProdutoDescricao + '^FS' + #13#10;
    vCodigoZPL := vCodigoZPL + '^FO50,180' + '^FD' + 'Quantidade: ' + vProdutoQuantidade + '^FS' + #13#10;
    vCodigoZPL := vCodigoZPL + '^FO50,210' + '^FD' + 'Valor: R$' + vProdutoValor + '^FS' + #13#10;
    vCodigoZPL := vCodigoZPL + '^FO50,240' + '^FD' + 'Data de Validade: ' + vProdutoDataValidade + '^FS' + #13#10;
    vCodigoZPL := vCodigoZPL + '^FO50,270' + '^FD' + 'Data da Entrega:' + vProdutoDataEntrega + '^FS' + #13#10;
